...
standard_board = [
    {'NAME':'GO', 'TYPE':'GO'},
    {'NAME':'Mediterranean Avenue', 'TYPE':'PROPERTY', 'SUIT':'BROWN', 'PRICE':60,
    'RENTS':[2,10,30,90,160,250], 'HOUSE_COST':50},
    {'NAME':'Community Chest', 'TYPE':'COMMUNITY_CHEST',},
    {'NAME':'Baltic Avenue', 'TYPE':'PROPERTY', 'SUIT':'BROWN', 'PRICE':60,
    'RENTS':[4,20,60,180,320,450],, 'HOUSE_COST':50},
    {'NAME':'Income Tax', 'TYPE':'INCOME_TAX'},

    {'NAME':'Reading Railroad', 'TYPE':'RAILROAD'},
    {'NAME':'Oriental Avenue', 'TYPE':'PROPERTY', 'SUIT':'LIGHT_BLUE', 'PRICE':100,
    'RENTS':[6,30,90,270,400,550], 'HOUSE_COST':50},
    {'NAME':'Chance', 'TYPE':'CHANCE'},
    {'NAME':'Vermont Avenue', 'TYPE':'PROPERTY', 'SUIT':'LIGHT_BLUE', 'PRICE':100,
    'RENTS':[6,30,90,270,400,550], 'HOUSE_COST':50},
    {'NAME':'Connecticut Avenue', 'TYPE':'PROPERTY', 'SUIT':'LIGHT_BLUE', 'PRICE':120,
    'RENTS':[8,40,100,300,450,600],  'HOUSE_COST':50},

    {'NAME':'Jail / Just Visiting', 'TYPE':'JAIL'},
    {'NAME':'St. Charles Place', 'TYPE':'PROPERTY', 'SUIT':'PINK', 'PRICE':140,
    'RENTS':[10,50,150,450,625,750], 'HOUSE_COST':100},
    {'NAME':'Electric Company', 'TYPE':'UTILITY', 'PRICE':150,},
    {'NAME':'States Avenue', 'TYPE':'PROPERTY', 'SUIT':'PINK', 'PRICE':140,
    'RENTS':[10,50,150,450,625,750], 'HOUSE_COST':100},
    {'NAME':'Virginia Avenue', 'TYPE':'PROPERTY', 'SUIT':'PINK', 'PRICE':160,
    'RENTS':[12,60,180,500,700,900], 'HOUSE_COST':100},

    {'NAME':'Pennsylvania Railroad', 'TYPE':'RAILROAD'},
    {'NAME':'St. James Place', 'TYPE':'PROPERTY', 'SUIT':'ORANGE', 'PRICE':180,
    'RENTS':[14,70,200,550,750,950], 'HOUSE_COST':100},
    {'NAME':'Community Chest', 'TYPE':'COMMUNITY_CHEST'},
    {'NAME':'Tenessee Avenue', 'TYPE':'PROPERTY', 'SUIT':'ORANGE', 'PRICE':180,
    'RENTS':[14,70,200,550,750,950], 'HOUSE_COST':100},
    {'NAME':'New York Avenue', 'TYPE':'PROPERTY', 'SUIT':'ORANGE', 'PRICE':200,
    'RENTS':[16,80,220,600,800,1000], 'HOUSE_COST':100},

    {'NAME':'Free Parking', 'TYPE':'FREE_PARKING'},
    {'NAME':'Kentucky Avenue', 'TYPE':'PROPERTY', 'SUIT':'RED', 'PRICE':220,
    'RENTS':[18,90,250,700,875,1050], 'HOUSE_COST':150},
    {'NAME':'Chance', 'TYPE':'CHANCE'},
    {'NAME':'Indiana Avenue', 'TYPE':'PROPERTY', 'SUIT':'RED', 'PRICE':220,
    'RENTS':[18,90,250,700,875,1050], 'HOUSE_COST':150},
    {'NAME':'Illinois Avenue', 'TYPE':'PROPERTY', 'SUIT':'RED', 'PRICE':240,
    'RENTS':[20,100,300,750,925,1100], 'HOUSE_COST':150},

    {'NAME':'B & O Railroad', 'TYPE':'RAILROAD'},
    {'NAME':'Atlantic Avenue', 'TYPE':'PROPERTY', 'SUIT':'YELLOW', 'PRICE':260,
    'RENTS':[22,110,330,800,975,1150], 'HOUSE_COST':150},
    {'NAME':'Ventnor Avenue', 'TYPE':'PROPERTY', 'SUIT':'YELLOW', 'PRICE':260,
    'RENTS':[22,110,330,800,975,1150], 'HOUSE_COST':150},
    {'NAME':'Water Works', 'TYPE':'UTILITY'},
    {'NAME':'Marvin Gardens', 'TYPE':'PROPERTY', 'SUIT':'YELLOW', 'PRICE':280,
    'RENTS':[24,120,360,850,1025,1200], 'HOUSE_COST':150},

    {'NAME':'Go To Jail', 'TYPE':'GO_TO_JAIL'},
    {'NAME':'Pacific Avenue', 'TYPE':'PROPERTY', 'SUIT':'GREEN', 'PRICE':300,
    'RENTS':[26,130,390,900,1100,1275], 'HOUSE_COST':200},
    {'NAME':'North Carolina Avenue', 'TYPE':'PROPERTY', 'SUIT':'GREEN', 'PRICE':300,
    'RENTS':[26,130,390,900,1100,1275], 'HOUSE_COST':200},
    {'NAME':'Community Chest', 'TYPE':'COMMUNITY_CHEST'},
    {'NAME':'Pennsylvania Avenue', 'TYPE':'PROPERTY', 'SUIT':'GREEN', 'PRICE':320,
